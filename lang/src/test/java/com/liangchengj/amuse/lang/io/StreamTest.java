...
class StreamTest {
  ...
  @Test
  void readAsBytes() throws IOException {
    String string =
        "\n"
            + "<!DOCTYPE html>\n"
            ...
            + "  \n"
            + "  window.ga('set', 'dimension7', '75d9d74b-7743-434b-a5c7-b215b5d80b74');\n"
            + "  \n"
    ...
    // System.out.println(new String(Stream.readAsBytes(new
    // ByteArrayInputStream(string.getBytes()))));

    Stream.readAndWrite(string, System.out);
  }
}
