...
public final class OutputAnalyzer {
  ...
  public OutputAnalyzer(Process process) throws IOException {
    OutputBuffer output = ProcessTool.getOutput(process);
  ...
  public OutputAnalyzer shouldMatch(String pattern) {
    ...
    if (!stdoutMatcher.find() && !stderrMatcher.find()) {
      reportDiagnosticSummary();
      throw new RuntimeException("'" + pattern + "' missing from stdout/stderr \n");
    }
    return this;
  }
  ...
  public OutputAnalyzer shouldNotMatch(String pattern) {
    ...
    if (matcher.find()) {
      reportDiagnosticSummary();
      throw new RuntimeException("'" + pattern + "' found in stdout: '" + matcher.group() + "' \n");
    }
    matcher = Pattern.compile(pattern, Pattern.MULTILINE).matcher(stderr);
    if (matcher.find()) {
      reportDiagnosticSummary();
      throw new RuntimeException("'" + pattern + "' found in stderr: '" + matcher.group() + "' \n");
    }
    return this;
  }
  ...
  public OutputAnalyzer shouldHaveExitValue(int expectedExitValue) {
    if (getExitValue() != expectedExitValue) {
      reportDiagnosticSummary();
      throw new RuntimeException("Expected to get exit value of [" + expectedExitValue + "]\n");
    }
    return this;
  }
  ...
  public OutputAnalyzer shouldNotHaveExitValue(int notExpectedExitValue) {
    if (getExitValue() == notExpectedExitValue) {
      ...
      throw new RuntimeException(
          "Unexpected to get exit value of [" + notExpectedExitValue + "]\n");
    }
    return this;
  }
