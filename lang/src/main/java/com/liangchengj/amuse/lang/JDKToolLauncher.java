 ...
 *
 * <p>The JDKToolLauncher can in particular be combined with a java.lang.ProcessBuilder to easily
 * run a JDK tool. For example, the following code run {@code jmap -heap} against a process with GC
 * logging turned on for the {@code jmap} process:
 *
 * <pre>{@code
...
public class JDKToolLauncher {
  ...
  /**
   * Creates a new JDKToolLauncher for the specified tool. Using tools path from the compiler JDK.
   *
   ...
   *
   * <p>The JVM arguments are passed to the underlying JVM running the tool. Arguments will
   * automatically be prepended with "-J".
   *
   * <p>Any platform specific arguments required for running the tool are automatically added.
   *
