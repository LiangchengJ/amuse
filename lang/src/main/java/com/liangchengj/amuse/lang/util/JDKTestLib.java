...
import com.liangchengj.amuse.lang.JDKToolLauncher;
import com.liangchengj.amuse.lang.process.OutputAnalyzer;
import com.liangchengj.amuse.lang.process.ProcessTool;
import java.io.File;
...
import static com.liangchengj.amuse.lang.Asserts.assertTrue;

/** Common library for various test helper functions. */
public final class JDKTestLib {
  ...
  public static String[] getFilteredTestJavaOpts(String... filters) {
    ...
    List<String> filteredOptions = new ArrayList<>(options.length);
  ...
  /**
   * Uses "jcmd -l" to search for a jvm pid. This function will wait forever (until jtreg timeout)
   * for the pid to be found.
   *
   ...
   *
   * <p>Example output from jcmd is: 12498 sun.tools.jcmd.JCmd -l 12254
   * /tmp/jdk8/tl/jdk/JTwork/classes/com/sun/tools/attach/Application.jar
   *
  ...
  public static int tryFindJvmPid(String key) throws Throwable {
    ...
    try {
      ...
      output = ProcessTool.executeProcess(jcmdLauncher.getCommand());
  ...
  public static long adjustTimeout(long tOut) {
    return Math.round(tOut * JDKTestLib.TIMEOUT_FACTOR);
  }
  ...
  //      bytes[i / 2] =
  //          (byte)
  //              ((Character.digit(hex.charAt(i), 16) << 4) + Character.digit(hex.charAt(i + 1),
  // 16));
  //    }
  //    return bytes;
  //  }
  ...
  /**
   * Returns {@link Random} generator initialized with particular seed. The seed could be provided
   * via system property {@link JDKTestLib#SEED_PROPERTY_NAME} In case no seed is provided, the
   * method uses a random number. The used seed printed to stdout.
   *
   * @return {@link Random} generator with particular seed.
   */
  public static Random getRandomInstance() {
    if (RANDOM_GENERATOR == null) {
      synchronized (JDKTestLib.class) {
        if (RANDOM_GENERATOR == null) {
  ...
  public static OutputAnalyzer uname(String... args) throws Throwable {
    ...
    return ProcessTool.executeCommand(cmds);
  }
   ...
   *
   * <p>This method is meant as a replacement for {@code Files#createTempFile(String, String,
