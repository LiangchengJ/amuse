 ...
 *
 * <p>An assertion will throw a {@link RuntimeException} if the assertion isn't true. All the
 * asserts can be imported into a test by using a static import:
 *
 * <pre>{@code
...
public class Asserts {
  ...
  public static <T extends Comparable<T>> void assertLessThan(T lhs, T rhs, String msg) {
    if (!(compare(lhs, rhs, msg) < 0)) {
      msg = Objects.toString(msg, "assertLessThan") + ": expected that " + lhs + " < " + rhs;
      fail(msg);
    }
  }
  ...
  public static <T extends Comparable<T>> void assertLessThanOrEqual(T lhs, T rhs, String msg) {
    if (!(compare(lhs, rhs, msg) <= 0)) {
      msg =
          Objects.toString(msg, "assertLessThanOrEqual") + ": expected that " + lhs + " <= " + rhs;
      fail(msg);
    }
  }
  ...
  public static void assertEquals(Object lhs, Object rhs, String msg) {
    if (!Objects.equals(lhs, rhs)) {
      msg = Objects.toString(msg, "assertEquals") + ": expected " + lhs + " to equal " + rhs;
      fail(msg);
    }
  }
  ...
  public static void assertSame(Object lhs, Object rhs, String msg) {
    if (lhs != rhs) {
      msg = Objects.toString(msg, "assertSame") + ": expected " + lhs + " to equal " + rhs;
      fail(msg);
    }
  }
  ...
  public static <T extends Comparable<T>> void assertGreaterThanOrEqual(T lhs, T rhs, String msg) {
    if (!(compare(lhs, rhs, msg) >= 0)) {
      msg = Objects.toString(msg, "assertGreaterThanOrEqual") + ": expected " + lhs + " >= " + rhs;
      fail(msg);
    }
  }
  ...
  public static <T extends Comparable<T>> void assertGreaterThan(T lhs, T rhs, String msg) {
    if (!(compare(lhs, rhs, msg) > 0)) {
      msg = Objects.toString(msg, "assertGreaterThan") + ": expected " + lhs + " > " + rhs;
      fail(msg);
    }
  }
  ...
  public static void assertNotEquals(Object lhs, Object rhs, String msg) {
    if (Objects.equals(lhs, rhs)) {
      msg = Objects.toString(msg, "assertNotEquals") + ": expected " + lhs + " to not equal " + rhs;
      fail(msg);
    }
  }
   ...
   *
   * <p>If strings are not equals, then exception message will contain {@code msg} followed by list
   * of mismatched lines.
   *
  ...
  public static void assertStringsEqual(String str1, String str2, String msg) {
    ...
    if (minLength < longestStringLines.length) {
      ...
      messageBuilder.append(
          String.format("Only %s string contains " + "following lines:\n", stringName));
      stringsAreDifferent = true;
