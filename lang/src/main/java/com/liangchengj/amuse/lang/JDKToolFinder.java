...
public final class JDKToolFinder {
  ...
  /**
   * Returns the full path to an executable in jdk/bin based on System property {@code test.jdk} or
   * {@code compile.jdk} (both are set by the jtreg test suite)
   *
  ...
  /**
   * Returns the full path to an executable in jdk/bin based on System property {@code compile.jdk}
   *
   * @return Full path to an executable in jdk/bin
   */
  ...
  /**
   * Returns the full path to an executable in jdk/bin based on System property {@code test.jdk}
   *
   * @return Full path to an executable in jdk/bin
   */
