...
public final class StreamPumper implements Runnable {
  ...
  public static final class StreamPump extends Pump {
  ...
  /**
   * Implements Thread.run(). Continuously read from {@code in} and write to {@code out} until
   * {@code in} has reached end of stream. Abort on interruption. Abort on IOExceptions.
   */
  @Override
  public void run() {
